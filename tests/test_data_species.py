...
class TestDataSpecies(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_parameters.thermochemical = (
            True  # Enable thermochemical calculations by default
        )
        self.mock_parameters.g_formation = (
            True  # Assume energy of formation is provided
        )
        self.mock_species_file = (
            "test_species_file.md"  # Simulated input file for testing
        )
    ...
    def test_initialization_valid_md_file(self, mock_raw_data):
        ...
        data_species = DataSpecies(
            self.mock_species_file, self.mock_parameters, self.mock_writer
        )
